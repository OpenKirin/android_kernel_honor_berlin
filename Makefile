...
LINUXINCLUDE += -I$(BALONG_TOPDIR)/modem/include/taf -I$(BALONG_TOPDIR)/modem/include -I$(srctree)/drivers -I$(srctree)/drivers/huawei_platform -I$(BALONG_TOPDIR)/ap/platform/hi6250 -I$(BALONG_TOPDIR)/audiodsp/include/ap/med
