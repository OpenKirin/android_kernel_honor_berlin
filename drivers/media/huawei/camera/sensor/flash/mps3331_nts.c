...
#define LED_OTAD_DISABLE 0  //bit7
#define TUP_I_8us        0  //bit4-bit6
#define VTH_PAS_300mV    0x0 //bit2, bit3
#define INDI_PWRM_2_16   0    //bit0, bit1
	...
	void *data)
{
    ...
    if(STANDBY_MODE == cdata->mode){
        ...
        i2c_func->i2c_write(i2c_client, INDICATOR_REG,
            (LED_OTAD_DISABLE | TUP_I_8us | VTH_PAS_300mV | INDI_PWRM_2_16));
