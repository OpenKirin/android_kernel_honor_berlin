...
struct sensor_power_setting imx219BLN_power_setting[] = {
...
struct sensor_power_setting imx219BLN_power_setting_dvdd120[] = {
    //disable main camera reset
    {
        .seq_type = SENSOR_SUSPEND,
        .config_val = SENSOR_GPIO_LOW,
...
static sensor_t s_imx219BLN =
{
    ...
    .power_setting_array = {
            .size = ARRAY_SIZE(imx219BLN_power_setting),
            .power_setting = imx219BLN_power_setting,
     },
};
...
static int32_t imx219BLN_platform_probe(struct platform_device* pdev)
{
    ...
    if (pdev->dev.of_node) {
		...
		if(DVDD120V == s_imx219BLN.board_info->ldo_diverse){
			...
			s_imx219BLN.power_setting_array.size = ARRAY_SIZE(imx219BLN_power_setting_dvdd120);
			s_imx219BLN.power_setting_array.power_setting = imx219BLN_power_setting_dvdd120;
		}
    } else {
