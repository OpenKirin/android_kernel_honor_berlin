...
/*lint +e413*/
#else
            (VOS_VOID)VOS_MemSet(&g_stRingBufferControlTXAddr, 0, sizeof(OM_COMM_VOICE_RING_BUFFER_CONTROL_STRU));
            g_stPcvOmToDspAddr.ulMailBoxAddr = (VOS_UINT_PTR)&g_stRingBufferControlTXAddr;

            (VOS_VOID)VOS_MemSet(&g_stRingBufferControlRXAddr, 0, sizeof(OM_COMM_VOICE_RING_BUFFER_CONTROL_STRU));
