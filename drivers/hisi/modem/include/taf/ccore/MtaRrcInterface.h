...
enum MTA_RRC_MSG_TYPE_ENUM
{
    ...
    ID_LRRC_MTA_SIB16_TIME_UPDATE              = MTA_LRRC_MSG_TYPE_BASE + 66,   /* _H2ASN_MsgChoice LRRC_MTA_SIB16_TIME_UPDATE_STRU */
...
/*****************************************************************************
 枚举名    : LRRC_MTA_TIME_TYPE_ENUM_UINT8
 枚举说明  : 频点频段查询的类型
  ...
  1.日    期   : 2016年5月7日
    ...
    修改内容   : 新增
*****************************************************************************/
enum LRRC_MTA_TIME_TYPE_ENUM
{
    LRRC_MTA_LOCAL_TIME            = 1,
    LRRC_MTA_GPS_TIME              = 2,
    LRRC_MTA_LOCAL_GPS_TIME        = 3,
    LRRC_MTA_TIME_BUTT
};
typedef VOS_UINT8   LRRC_MTA_TIME_TYPE_ENUM_UINT8;
/*****************************************************************************
 枚举名    : LRRC_MTA_TIME_TYPE_ENUM_UINT8
 枚举说明  : 频点频段查询的类型
  ...
  1.日    期   : 2016年5月7日
    ...
    修改内容   : 新增
*****************************************************************************/
enum LRRC_MTA_DAY_LIGHT_SAVING_IND_ENUM
{

    LRRC_MTA_NO_ADJUST       = 0,
    LRRC_MTA_ONE_HOUR        = 1,
    LRRC_MTA_TWO_HOUR        = 2,
    LRRC_MTA_HOUR_BUTT
};
typedef VOS_UINT8   LRRC_MTA_DAY_LIGHT_SAVING_IND_ENUM_UINT8;
...
/*****************************************************************************
 结构名    : MTA_WRR_CSNR_QRY_REQ_STRU
 结构说明  : MTA给WRR下发查询CSNR 消息
...
/*****************************************************************************
 结构名    : WRR_MTA_CSNR_QRY_CNF_STRU
 结构说明  : WRR给MTA回复查询CSNR CNF消息
...
/*****************************************************************************
结构名    : LRRC_MTA_RESTRICTED_BAND_STRU
结构说明  : 受限Band
...
/*****************************************************************************
结构名    : MTA_LRRC_CAMPED_RESTRICTED_BAND_IND_STRU
结构说明  : 受限Band上报
...
/*****************************************************************************
结构名    : LRRC_MTA_SIB16_TIME_UPDATE_STRU
结构说明  : 时间更新
...
{
    MSG_HEADER_STRU                           stMsgHeader;         /*_H2ASN_Skip*/
    LRRC_MTA_TIME_TYPE_ENUM_UINT8             enTimeType;          /* 1:local time; 2:GPS time; 3:both time */
    LRRC_MTA_DAY_LIGHT_SAVING_IND_ENUM_UINT8  enDayLightSavingInd; /* 0:no adjust; 1:+1 hour; 2:+2 hour */
    VOS_UINT8                                 aucRsv[2];
    LRRC_MTA_TIME_STRU                        stLocalTime;
    LRRC_MTA_TIME_STRU                        stGpsTime;
}LRRC_MTA_SIB16_TIME_UPDATE_STRU;
