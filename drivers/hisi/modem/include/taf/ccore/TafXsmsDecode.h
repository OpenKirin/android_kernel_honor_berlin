...
#define TAF_XSMS_TELESERVICE_NORMAL_SMS         (4098) /* 普通短信 */
...
#define TAF_XSMS_BEARER_DATA_POS_WITH_MSG_TYPE      (0x25)
#define TAF_XSMS_BEARER_DATA_POS_WITHOUT_MSG_TYPE   (0x1D)
