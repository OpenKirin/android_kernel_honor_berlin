...
enum MTC_RCM_MSG_ID_ENUM
{
    ...
    ID_MTC_RCM_SAR_ADDITIONAL_BACKOFF_LEVEL_NOTIFY  = 0x182C,
...
/*******************************************************************************
 结构名    : MTC_RCM_SAR_ADDITIONAL_BACKOFF_LEVEL_NOTIFY_STRU
 结构说明  : MTC接收到的SAR的功率回退档位
...
typedef struct
{
    ...
    MTC_RCM_MSG_HEADER_STRU             stMsgHeader;                  /*_H2ASN_Skip*/
    VOS_UINT16                          usSarAdditionalBackoffLevel;  /* 功率回退档位 */
    VOS_UINT16                          usReserved;
}MTC_RCM_SAR_ADDITIONAL_BACKOFF_LEVEL_NOTIFY_STRU;
