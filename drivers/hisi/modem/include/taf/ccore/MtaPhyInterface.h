...
/*****************************************************************************
枚举名    : PHY_MTA_AFC_CLK_UNLOCK_CAUSE_ENUM
结构说明  : AFC时钟失锁原因值枚举
  ...
  1.日    期   : 2016年06月15日
    ...
    修改内容   : 新增枚举
*****************************************************************************/
enum PHY_MTA_AFC_CLK_UNLOCK_CAUSE_ENUM
{
    PHY_MTA_AFC_CLK_UNLOCK_CAUSE_SLEEP  = 0,

    PHY_MTA_AFC_CLK_UNLOCK_CAUSE_BUTT
};
typedef VOS_UINT16 PHY_MTA_AFC_CLK_UNLOCK_CAUSE_ENUM_UINT16;

/*****************************************************************************
枚举名    : PHY_MTA_MODEM_ID_ENUM
结构说明  : PHY与MTA接口中定义Modem ID

  1.日    期   : 2016年07月01日
    作    者   : l00198894
    修改内容   : 新增枚举
*****************************************************************************/
enum PHY_MTA_MODEM_ID_ENUM
{
    PHY_MTA_MODEM_ID_0  = 0,
    PHY_MTA_MODEM_ID_1,
    PHY_MTA_MODEM_ID_2,

    PHY_MTA_MODEM_ID_BUTT
};
typedef VOS_UINT16 PHY_MTA_MODEM_ID_ENUM_UINT16;
...
enum MTA_PHY_MSG_TYPE_ENUM
{
    ...
    ID_MTA_RCM_NW_TIME_INFO_NTF                 = 0x7D03,                       /* _H2ASN_MsgChoice MTA_RCM_NW_TIME_INFO_NTF_STRU */

    ID_RCM_MTA_AFC_CLK_UNLOCK_IND               = 0x7D04,
  
    ID_MTA_APM_RX_TEST_MODE_SET_REQ             = 0x7D05,                       /* _H2ASN_MsgChoice MTA_APM_RX_TEST_MODE_SET_REQ_STRU */
    ID_APM_MTA_RX_TEST_MODE_SET_CNF             = 0x7D06,                       /* _H2ASN_MsgChoice APM_MTA_RX_TEST_MODE_SET_CNF_STRU */

    ID_MTA_RCM_RFIC_DIE_ID_READ_REQ             = 0x7D07,
    ID_RCM_MTA_RFIC_DIE_ID_READ_CNF             = 0x7D08,
...
typedef struct
{
    ...
    PHY_MTA_MODEM_ID_ENUM_UINT16        enModemId;
    VOS_UINT16                          usReserved;
} RCM_MTA_AFC_CLK_INFO_QRY_CNF_STRU;

/*******************************************************************************
 结构名    : RCM_MTA_AFC_CLK_UNLOCK_IND_STRU
 结构说明  : RCM通知MTA模块AFC时钟失锁原因结构体
...
{
    MTA_PHY_MSG_HEADER                                                          /*_H2ASN_Skip*/
    PHY_MTA_AFC_CLK_UNLOCK_CAUSE_ENUM_UINT16                enCause;
    VOS_UINT16                                              usReserved;        /* 保留位 */
}RCM_MTA_AFC_CLK_UNLOCK_IND_STRU;

/*****************************************************************************
 结构名    : MTA_RCM_NW_TIME_INFO_STRU
 结构说明  : 时间信息
 1.日    期   : 2016年5月5日
   作    者   : z00359541
   修改内容   : 新建
...
}MTA_RCM_NW_TIME_INFO_STRU;

/*******************************************************************************
 结构名    : MTA_RCM_NW_TIME_INFO_NOTIFY_STRU
 结构说明  : 从网络获取的时间信息
...
typedef struct
{
    ...
    MTA_PHY_MSG_HEADER                                                          /*_H2ASN_Skip*/
    MTA_RCM_NW_TIME_INFO_STRU           stTimeInfo;                        /* 从网络获取的时间信息 */
}MTA_RCM_NW_TIME_INFO_NOTIFY_STRU;

/*******************************************************************************
 结构名    : MTA_APM_RX_TEST_MODE_SET_REQ_STRU_STRU
 结构说明  : UEPS_PID_MTA发送到APM的RX测试模式设置请求
...
{
    MTA_PHY_MSG_HEADER                                                          /*_H2ASN_Skip*/
    VOS_UINT16                          usRxTestModeFlag ;                      /* 0退出测试模式 1:进入测试模式 */
    VOS_UINT16                          ausReserved1[1];
}MTA_APM_RX_TEST_MODE_SET_REQ_STRU;

/*******************************************************************************
 结构名    : APM_MTA_RX_TEST_MODE_SET_CNF_STRU
 结构说明  : APM发送到MTA的RX测试模式设置请求响应
...
typedef struct
{
    ...
    MTA_PHY_RESULT_ENUM_UINT16          enResult;                               /* 操作结果 */
    VOS_UINT16                          ausReserved1[1];
} APM_MTA_RX_TEST_MODE_SET_CNF_STRU;


/*******************************************************************************
 结构名    : MTA_RCM_RFIC_DIE_ID_READ_REQ_STRU
 结构说明  : UEPS_PID_MTA发送到RCM的RFIC DIE ID读取请求
...
typedef struct
{
    MTA_PHY_MSG_HEADER                                                          /*_H2ASN_Skip*/
    VOS_UINT16                          ausReserved1[2];
}MTA_RCM_RFIC_DIE_ID_READ_REQ_STRU;

/*******************************************************************************
 结构名    : RCM_MTA_RFIC_DIE_ID_READ_CNF_STRU
 结构说明  : RCM回复给MTA的RFIC DIE ID读取结果
...
}RCM_MTA_RFIC_DIE_ID_READ_CNF_STRU;
