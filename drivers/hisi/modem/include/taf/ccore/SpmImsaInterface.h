...
/*****************************************************************************
枚举名    : SPM_IMSA_CS_SRV_STATUS_ENUM
结构说明  : SPM当前的CS业务状态
...
/*****************************************************************************
枚举名    : IMSA_SPM_IMS_SWITCH_STATE_ENUM
结构说明  : IMS开关机状态枚举
...
/*****************************************************************************
 结构名  : SPM_IMSA_GET_CS_SRV_STATE_RSP_STRU
 结构说明: IMSA获取SPM当前CS业务状态响应
...
/*****************************************************************************
 结构名  : IMSA_SPM_GET_CS_SRV_STATE_IND_STRU
 结构说明: IMSA获取SPM当前CS业务状态指示
...
/*****************************************************************************
 结构名  : IMSA_SPM_IMS_SWITCH_STATE_IND_STRU
 结构说明: IMS开关机的状态指示
...
typedef struct
{
    VOS_MSG_HEADER                                                              /* _H2ASN_Skip */
    VOS_UINT32                              ulMsgId;                            /* _H2ASN_Skip */
    IMSA_SPM_IMS_SWITCH_STATE_ENUM_UINT8    enImsWifiSwitch;                    /* Ims Wifi的开关指示 */
