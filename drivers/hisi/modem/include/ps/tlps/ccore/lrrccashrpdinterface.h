...
/** ****************************************************************************
 枚举名    : LRRC_CAS_HRPD_BSR_FAIL_REASON_ENUM
 协议表格  :
 ASN.1描述 :
 枚举说明  : C2L背景搜失败原因值
*****************************************************************************/
enum LRRC_CAS_HRPD_BSR_FAIL_REASON_ENUM
{
    LRRC_CAS_HRPD_BSR_FAIL_NOT_SATISFY_NVTHRESHOLD    = 0x00,
    LRRC_CAS_HRPD_BSR_FAIL_NOT_SATISFY_SVALUE         = 0x01,
    LRRC_CAS_HRPD_BSR_FAIL_SIB_RCV_FAIL               = 0x02,
    LRRC_CAS_BSR_FAIL_CELL_BARRED                     = 0x03,
    LRRC_CAS_BSR_FAIL_BAND_NOT_SUPP                   = 0x04,
    LRRC_CAS_BSR_FAIL_NO_RF                           = 0x05,
    LRRC_CAS_BSR_FAIL_AC_BARRED                       = 0x06,
    LRRC_CAS_BSR_FAIL_CELL_FORBIDDEN                  = 0x07,
    LRRC_CAS_BSR_FAIL_ENUM_BUTT                       = 0x08
};
typedef VOS_UINT8 LRRC_CAS_HRPD_BSR_FAIL_REASON_ENUM_UINT8;
...
/*****************************************************************************
 结构名    : LRRC_LCSELBG_C2L_BEST_CELL_INFO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :C2L背景搜搜到最强小区信息
*****************************************************************************/
typedef struct
{
   ...
   VOS_INT16                                     sRsrp;
   VOS_INT16                                     sRsrq;
 }LRRC_CAS_HRPD_BSR_BEST_CELL_INFO_STRU;
/*****************************************************************************
 结构名    : LRRC_LCSELBG_C2L_BEST_CELL_INFO_STRU
 协议表格  :
 ASN.1描述 :
...
typedef struct
{
   LRRC_CAS_HRPD_BSR_BEST_CELL_INFO_STRU          stBestCellInfo;
   LRRC_CAS_HRPD_BSR_FAIL_REASON_ENUM_UINT8       enBsrFailReason;
   VOS_UINT8                                      aucReserved[3];
}LRRC_CAS_HRPD_BSR_FAIL_RSLT_STRU;
/*******************************************************************************
...
typedef struct
{
	...
	LRRC_CAS_HRPD_BSR_FAIL_RSLT_STRU                        stBsrFailRslt;
