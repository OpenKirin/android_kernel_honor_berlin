...
typedef VOS_UINT32 CDS_BASTET_BOOL;

typedef CDS_BASTET_BOOL ( *CDS_BST_SEND_QUE_SIZE_FUNC)(
    VOS_UINT32* pulCurSize,
    VOS_UINT32* pulMaxSize );
...
#define CDS_BASTET_FALSE                (0)
#define CDS_BASTET_TRUE                 (1)

/*最大丢包个数*/
#define BST_CDS_IP_PKT_DROP_MAX_NUM      (128)
...
enum    BST_CDS_MSG_ID_ENUM
{
    ...
    /* CDS发给BASTET的消息原语: ASPEN丢包消息 */
    ID_BST_CDS_FC_PKT_DROP_IND,                /* _H2ASN_MsgChoice BST_CDS_SEND_CB_INFO_STRU */
...
/*****************************************************************************
 结构名称   : CDS_BASTET_PKT_DROP_TYPE_ENUM
 协议表格   :
 ASN.1 描述 : 由于8位中高4位BASTET需要用于模块类型，只有低4位可以使用
 结构说明   : CDS流控丢包类型
*****************************************************************************/
enum CDS_BASTET_PKT_DROP_TYPE_ENUM
{
    CDS_BASTET_PKT_DROP_TYPE_ENQUE_FAIL       = 0,
    CDS_BASTET_PKT_DROP_TYPE_CLR_BUFFER       = 1,
    CDS_BASTET_PKT_DROP_TYPE_BUTT
};
typedef VOS_UINT16 CDS_BASTET_PKT_DROP_TYPE_ENUM_UINT16;
...
typedef struct
{
    ...
    CDS_BST_SEND_QUE_SIZE_FUNC          pSendQueSizeCbFun;
...
/*****************************************************************************
结构名    : BST_CDS_PKT_DROP_MSG_STRU
结构说明  : BASTET与CDS模块丢包消息
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                         /*_H2ASN_Skip*/
    VOS_UINT32                          ulMsgId;
    VOS_UINT32                          ulPktNum;                              /* 丢报个数*/
    BST_CDS_TCP_INFO                    astDropPkt[BST_CDS_IP_PKT_DROP_MAX_NUM];/* 丢包信息 */
} BST_CDS_PKT_DROP_MSG_STRU;
