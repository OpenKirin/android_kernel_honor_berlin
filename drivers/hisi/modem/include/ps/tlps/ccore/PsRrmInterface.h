...
/*****************************************************************************
  2 宏定义
*****************************************************************************/
#define RRM_PS_MAX_TASK_TYPE_NUM                            (16)
...
enum PS_RRM_MSG_TYPE_ENUM
{
    ...
    ID_RRM_PS_RADIO_RESOURCE_CHECK_IND                          = 0x0013,       /* _H2ASN_MsgChoice RRM_PS_RADIO_RESOURCE_CHECK_IND_STRU */
...
enum RRM_PS_TASK_TYPE_ENUM
{
    ...
    RRM_PS_TASK_TYPE_GSM_COMBINED_ATTACH            = 128,
    RRM_PS_TASK_TYPE_GSM_COMBINED_RAU               = 129,
    ...
    RRM_PS_TASK_TYPE_WCDMA_COMBINED_ATTACH          = 231,
    RRM_PS_TASK_TYPE_WCDMA_COMBINED_RAU             = 232,
    RRM_PS_TASK_TYPE_WCDMA_RRC_CONNECT              = 233,
    ...
    RRM_PS_TASK_TYPE_TDS_COMBINED_ATTACH            = 332,
    RRM_PS_TASK_TYPE_TDS_COMBINED_RAU               = 333,
    ...
    RRM_PS_TASK_TYPE_1X_CS_MO                       = 503,
    RRM_PS_TASK_TYPE_1X_PS_CALL                     = 504,
    RRM_PS_TASK_TYPE_1X_SIGNAL                      = 505,
    RRM_PS_TASK_TYPE_1X_MO_SMS                      = 506,
    RRM_PS_TASK_TYPE_1X_TCH_REL_NETWORK_SEARCH      = 507,
    RRM_PS_TASK_TYPE_1X_CS_MT                       = 508,
    RRM_PS_TASK_TYPE_1X_CS_EMERGENCY_CALL           = 509,
    RRM_PS_TASK_TYPE_1X_MT_SMS                      = 510,
...
/*******************************************************************************
 枚举名    : PS_RRM_VERSION_ENUM_UINT8
 结构说明  : 当前版本类型
 1.日    期   : 2016年03月7日
   作    者   : g00260269
   修改内容   : Added for SRLTE
*******************************************************************************/
...
/*******************************************************************************
 枚举名    : PS_RRM_DSDS_VERSION_ENUM_UINT8
 结构说明  : DSDS版本
 1.日    期   : 2016年03月7日
   作    者   : g00260269
   修改内容   : Added for DSDS2.0
*******************************************************************************/
...
/*******************************************************************************
 结构名    : RRM_PS_RADIO_RESOURCE_CHECK_IND_STRU
 结构说明  : RRM通知PS检查当前任务状态，RRM通知的时候发送的是接收PID的申请和使用
             任务列表，接收PID仅处理本PID有效的任务

  1.日    期   : 2016年12月05日
    作    者   : y00391477
    修改内容   : Added for Resource Check
*******************************************************************************/
typedef struct
{
    MSG_HEADER_STRU                     stMsgHeader;
    RRM_PS_TASK_TYPE_ENUM_UINT16        aenTaskTypeList[RRM_PS_MAX_TASK_TYPE_NUM];
}RRM_PS_RADIO_RESOURCE_CHECK_IND_STRU;
...
/* 供各个模式查询某任务是否正在使用资源 */
extern PS_BOOL_ENUM_UINT8 RRM_FindTaskIsUsingRfResource
(
    MODEM_ID_ENUM_UINT16                enModemId,
    VOS_RATMODE_ENUM_UINT32             enRatType,
    RRM_PS_TASK_TYPE_ENUM_UINT16        enTaskType
