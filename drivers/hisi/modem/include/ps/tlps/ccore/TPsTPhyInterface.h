...
enum
{
      /*TPS-->TPhy Request  Begin*/
        ...
        ID_TRRC_TPHY_MAX_SYS_INFO_REP_IND,     /*4998*/
...
typedef struct
{
    ...
    VOS_UINT8                                   ucTestCardFlg;         /* 0-非测试卡,1-测试卡 */
    VOS_UINT8                                   ucResv[3];             /* 保留 */
...
/* DSDS2.0 end */
/*****************************************************************************
 结构名    : TRRC_TPHY_SYS_INFO_MAX_REP_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 通知物理层系统消息最大调度周期
*****************************************************************************/
...
typedef struct
{
    ...
    VOS_UINT8                                   ucSysType;                /*配置此条消息时候当前的系统消息类型*/
    VOS_UINT8                                   ucRsv;
}TRRC_TPHY_SYS_INFO_MAX_REP_STRU;
