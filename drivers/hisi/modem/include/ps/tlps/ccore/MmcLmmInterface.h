...
#define MMC_LMM_MAX_PLMN_STATUS_NUM              (16)

#define MMC_LMM_MAX_IMSI_WITH_HEAD_LEN           (9)

#define MMC_LMM_MAX_IMEI_LEN                    (16)
...
enum    MMC_LMM_MSG_ID_ENUM
{
    ...
    ID_MMC_LMM_NOT_BACK_LTE_CHR_NOTIFY  = (PS_MSG_ID_MMC_TO_LMM_BASE+0X2A),     /* _H2ASN_MsgChoice MMC_LMM_NOT_BACK_LTE_CHR_NOTIFY_STRU */
    ...
    ID_LMM_MMC_PLMN_STATUS_IND         = (PS_MSG_ID_LMM_TO_MMC_BASE+0x2C),      /* _H2ASN_MsgChoice LMM_MMC_PLMN_STATUS_IND_STRU */

    ID_LMM_MMC_ANYCELL_SEARCH_NOTIFY   = (PS_MSG_ID_LMM_TO_MMC_BASE+0x2D),      /* _H2ASN_MsgChoice LMM_MMC_ANYCELL_SEARCH_NOTIFY_STRU */
    ID_LMM_MMC_RRM_RADIO_RESOURCE_CHECK_IND   = (PS_MSG_ID_LMM_TO_MMC_BASE+0x2E), /* _H2ASN_MsgChoice LMM_MMC_RRM_RADIO_RESOURCE_CHECK_IND_STRU */
...
enum MMC_LMM_PLMN_SRCH_TYPE_ENUM
{
    ...
    /* Modified by z00234330 for 搜网优化5.0, 2015-12-02,begin */
     MMC_LMM_PLMN_SRCH_USER_LIST        = 1,                /* 非美国搜网定制的列表搜，可以是驻留态，也可以是非驻留态 */
    /* Modified by z00234330 for 搜网优化5.0, 2015-12-02,end */
    ...
    /* Added by z00234330 for 搜网优化5.0, 2015-12-02,begin */
    ...
    /* Added by z00234330 for 搜网优化5.0, 2015-12-02,end */
...
/* Added by s00217060 for 美国搜网定制, 2016-1-30, begin */
/*****************************************************************************
...
/* Added by s00217060 for 美国搜网定制, 2016-1-30, end */
...
{
    /* Modified by s00217060 for 美国搜网定制, 2016-1-28, begin */
    ...
    /* Modified by s00217060 for 美国搜网定制, 2016-1-28, end */
...
{
    /* Modified by s00217060 for 开机搜网优化, 2016-4-21, begin */
    MMC_LMM_PLMN_SEARCH_SCENE_SWITCH_ON         = 0,        /* 开机搜网 */
    MMC_LMM_PLMN_SEARCH_SCENE_CL_BG_SEARCH  = 1,           /* VIA CL多模形态下的带门限要求的背景搜网，目前仅用于指定搜和背景搜 */
    MMC_LMM_PLMN_SEARCH_SCENE_OOS               = 2,        /* OOS搜网 */
    MMC_LMM_PLMN_SEARCH_SCENE_OTHER             = 3,        /* 其他搜网场景 */
    MMC_LMM_PLMN_SEARCH_SCENE_BUTT
    /* Modified by s00217060 for 开机搜网优化, 2016-4-21, end */
};
...
/****************************************************************************
 枚举名称: NAS_LMM_NOT_BACK_LTE_ACTION_ENUM_UINT8
 协议表格:
 ASN.1 描述:
 枚举说明:   GU NAS提供给LRRC的不回4G CHR的全局变量的操作
*****************************************************************************/
enum NAS_LMM_LTE_LOST_IND_ACTION_ENUM
{
    NAS_LMM_ACTION_CLEAN_GLOBAL_VARIABLE_REPORT_EVENT   = 0,     /* 清除全局变量，上报事件 */
    NAS_LMM_ACTION_CLEAN_GLOBAL_VARIABLE_ONLY           = 1,     /* 清除全局变量 */
    NAS_LMM_ACTION_BUTT
};
typedef VOS_UINT8 NAS_LMM_NOT_BACK_LTE_ACTION_ENUM_UINT8;
...
enum MMC_LMM_ATTACH_RSLT_ENUM
{
    ...
    MMC_LMM_ATT_RSLT_THROT_NOT_ALLOWED,                                         /* 调节算法不允许发起 */

    MMC_LMM_ATT_RSLT_THROT_T3396_IS_RUNNING,                                         /* T3396不允许发起 */
...
enum MMC_LMM_TAU_RSLT_ENUM
{
    ...
    MMC_LMM_TAU_RSLT_THROT_NOT_ALLOWED,                                         /* 调节算法不允许发起 */
...
enum MMC_LMM_SERVICE_TYPE_ENUM
{
    ...
    MMC_LMM_SERVICR_PACKET_SEVICEES_VIA_S1      = 0x8,
...
/*****************************************************************************
 结构名    : LMM_MMC_PLMN_STATUS_ENUM
 结构说明  : LMM上报的PLMN状态
 *****************************************************************************/
enum LMM_MMC_PLMN_STATUS_ENUM
{
    LMM_MMC_PLMN_STATUS_NORMAL         = 0,       /* 因3402定时器停止或超时导致临时禁止的PLMN恢复正常状态 */
    LMM_MMC_PLMN_STATUS_FORBIDDEN      = 1,       /* 因3402定时器启动导致的PLMN进入临时禁止状态 */

    LMM_MMC_PLMN_STATUS_BUTT
};
typedef VOS_UINT32 LMM_MMC_PLMN_STATUS_ENUM_UINT32;
...
typedef struct
{
    ...
    /* Modified by n00355355 for 美国搜网定制, 2016-2-25, begin */
    MMC_LMM_RAT_TYPE_ENUM_UINT8          enRat;
    VOS_UINT8                            aucReserve[3];
    /* Modified by n00355355 for 美国搜网定制, 2016-2-25, end */
}NAS_LMM_TAI_STRU;
...
/*****************************************************************************
结构名称: NAS_LMM_CARD_STATUS_INFO_STRU
协议表格:
ASN.1 描述:
结构说明:
1.日    期   : 2016年8月12日
作    者   : w00167002
修改内容   : 开机读卡优化修改:封装卡状态信息。
*****************************************************************************/
typedef struct
{
    MMC_LMM_USIM_STATUS_ENUM_UINT32     ulUsimState;                            /* SIM卡是否存在状态 */
    VOS_UINT8                           ucCardChangedStatus;                    /* SIM卡是否改变状态:FALSE表示卡IMSI信息没有改变 */
    VOS_UINT8                           aucImsi[MMC_LMM_MAX_IMSI_WITH_HEAD_LEN];/* 卡存在时携带IMSI内容,第一个字节表示长度，长度为0x0/0xff表示无效 */
    VOS_UINT8                           aucReserved2[2];                        /* 保留 */
}NAS_LMM_CARD_STATUS_INFO_STRU;
...
typedef struct
{
    ...
    NAS_LMM_CARD_STATUS_INFO_STRU       stCardStatusInfo;
    ...
    VOS_UINT8                           aucImei[MMC_LMM_MAX_IMEI_LEN];
...
typedef struct
{
    ...
    /* Added by s00217060 for 开机搜网优化, 2016-4-21, begin */
    MMC_LMM_SEARCHED_TYPE_STRU          stSearchedType;                         /* AS上报搜网回复时已经搜索过类型 */
    /* Added by s00217060 for 开机搜网优化, 2016-4-21, end */
...
typedef struct
{
    ...
    /* Modified by s00217060 for 美国搜网定制, 2016-1-30, begin */
    MMC_LMM_BG_SRCH_HRPD_RLT_ENUM_UINT32    enRlst;
    /* Modified by s00217060 for 美国搜网定制, 2016-1-30, end */
...
/*****************************************************************************
 结构名    : LMM_MMC_PLMN_STATUS_IND_STRU
 协议表格  : LMM将因3402定时器状态变化的PLMN上报给MMC，主要在DATA RETRY特性中使用，
             如果3402定时器启动，则在LTE下将此消息携带的PLMN临时作为禁止PLMN，
             如果3402定时器停止或超时，则原来因3402定时器启动而临时禁止的此消息中携带的相应PLMN解禁。
 ASN.1描述 :
 结构说明  : ID_LMM_MMC_PLMN_STATUS_IND对应的结构体
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                      /*_H2ASN_Skip*/
    ...
    LMM_MMC_PLMN_STATUS_ENUM_UINT32         enPlmnStatus;     /* 针对下面所有PLMN都有效，且状态相同 */

    /* PLMN列表，最多16个PLMN，目前只有开机读NV时可能为多个，其他情况一般只有1个 */
    VOS_UINT8                               ucPlmnNum;
    VOS_UINT8                               aucRsv[3];
    MMC_LMM_PLMN_ID_STRU                    astPlmnId[MMC_LMM_MAX_PLMN_STATUS_NUM];
}LMM_MMC_PLMN_STATUS_IND_STRU;

/*****************************************************************************
 结构名    : MMC_LMM_NOT_BACK_LTE_CHR_NOTIFY_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : ID_MMC_LMM_NOT_BACK_LTE_CHR_NOTIFY对应的结构体
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                                      /*_H2ASN_Skip*/
    MMC_LMM_MSG_ID_ENUM_UINT32                              ulMsgId;    /*_H2ASN_Skip*/
    NAS_LMM_NOT_BACK_LTE_ACTION_ENUM_UINT8                  enAction;
    VOS_UINT8                                               aucRsv[3];
}MMC_LMM_NOT_BACK_LTE_CHR_NOTIFY_STRU;

/*****************************************************************************
 结构名    : LMM_MMC_ANYCELL_SEARCH_NOTIFY_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : ID_LMM_MMC_ANYCELL_SEARCH_NOTIFY对应的结构体
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                                      /*_H2ASN_Skip*/
    MMC_LMM_MSG_ID_ENUM_UINT32                              ulMsgId;    /*_H2ASN_Skip*/
    VOS_UINT8                                               aucRsv[4];
}LMM_MMC_ANYCELL_SEARCH_NOTIFY_STRU;

/*****************************************************************************
结构名    : LMM_MMC_RRM_RADIO_RESOURCE_CHECK_IND_STRU
协议表格  :
ASN.1描述 :
结构说明  : ID_LMM_MMC_RRM_RADIO_RESOURCE_CHECK_IND消息结构
            用于通知MMC资源核查任务，若有多个任务，分多条消息发送
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                          /*_H2ASN_Skip*/
    MMC_LMM_MSG_ID_ENUM_UINT32             enMsgId;         /*_H2ASN_Skip*/
    MMC_LMM_SESSION_TYPE_ENUM_UINT8        enSessionType;
    VOS_UINT8                              aucRsv[3];       /* 保留字节 */
}LMM_MMC_RRM_RADIO_RESOURCE_CHECK_IND_STRU;
