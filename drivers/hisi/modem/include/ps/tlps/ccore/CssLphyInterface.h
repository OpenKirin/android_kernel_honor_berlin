...
#define CSS_LPHY_FFT_SCAN_ONCE_MAX_FREQ_NUM  (500)           /* 受OSA消息大小的限制，一次上报扫频结果的频率个数 */
...
enum CSS_LPHY_MSG_ID_ENUM
{
    ...
    ID_CSS_LPHY_FFT_BAND_SCAN_REQ               = CSS_LPHY_MSG_HDR + 0x05, /* _H2ASN_MsgChoice CSS_LPHY_FFT_BAND_SCAN_REQ_STRU */
    ...
    ID_CSS_LPHY_FFT_BAND_SCAN_IND               = LPHY_CSS_MSG_HDR + 0x26, /* _H2ASN_MsgChoice CSS_LPHY_FFT_BAND_SCAN_IND_STRU */
...
/*****************************************************************************
 结构名    : CSS_LPHY_FFT_BAND_SCAN_REQ_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 协议栈指示物理层200K粒度FFT扫频数据结构
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                                                  /*_H2ASN_Skip*/
    ...
    CSS_LPHY_LTE_MODE_TYPE_ENUM_UINT16              enLteModeType;                  /* 指示频点所属的制式类型, FDD或TDD */
    CSS_LPHY_FREQ_RANGE_INFO_STRU                   stFreqRangeInfo;                /* 频段信息 */
}CSS_LPHY_FFT_BAND_SCAN_REQ_STRU;


/*****************************************************************************
 结构名    : CSS_LPHY_FFT_BAND_SCAN_RESULT_LIST_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 200K粒度FFT扫频结果数据结构
*****************************************************************************/
typedef struct
{
    VOS_UINT16                                    bitOpLteSupport: 1;             /* enBandInd是否支持L制式*/
    ...
    VOS_UINT16                                    bitOpTdsSupport: 1;             /* enBandInd是否支持T制式*/
    VOS_UINT16                                    bitOpSpace: 12;                 /* 保留字段 */
    VOS_UINT16                                    usFreqRangeTotalNum;            /* 该BAND总共有多少个频率 */
    CSS_LPHY_BAND_IND_ENUM_UINT16                 enBandInd;                      /* 频带指示 */
    VOS_UINT16                                    usFreqRangeNum;                 /* 物理层本次上报的频率数目 */
    CSS_LPHY_FREQ_INFO_STRU                       astFreqScanResult[CSS_LPHY_FFT_SCAN_ONCE_MAX_FREQ_NUM]; /* 频段信息 */
}CSS_LPHY_FFT_BAND_SCAN_RESULT_LIST_STRU;



/*****************************************************************************
 结构名    : CSS_LPHY_FFT_BAND_SCAN_IND_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  : 200K粒度FFT扫频结果数据结构
*****************************************************************************/
typedef struct
{
    ...
    VOS_UINT16                                    usOpId;                       /* 操作标识符 */
    VOS_UINT16                                    usNoRfValid;                  /* DSDS特性NORF指示 */
    CSS_LPHY_FFT_BAND_SCAN_RESULT_LIST_STRU       stBandScanResult;             /* 扫频结果 */
}CSS_LPHY_FFT_BAND_SCAN_IND_STRU;
