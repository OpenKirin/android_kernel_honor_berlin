...
enum MM_LMM_MSG_ID_ENUM
{
    ...
    ID_LMM_MM_RRM_RADIO_RESOURCE_CHECK_IND = 0x06+PS_MSG_ID_LMM_TO_MM_BASE,    /* _H2ASN_MsgChoice LMM_MM_RRM_RADIO_RESOURCE_CHECK_IND_STRU */
...
/*****************************************************************************
结构名    : LMM_MM_RRM_RADIO_RESOURCE_CHECK_IND_STRU
协议表格  :
ASN.1描述 :
结构说明  : ID_LMM_MM_RRM_RADIO_RESOURCE_CHECK_IND消息结构
            用于通知MM资源核查任务，若有多个任务，分多条消息发送
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER                                          /*_H2ASN_Skip*/
    MM_LMM_MSG_ID_ENUM_UINT32             enMsgId;          /*_H2ASN_Skip*/
    MM_LMM_SESSION_TYPE_ENUM_UINT8        enSessionType;
    VOS_UINT8                             aucRsv[3];        /* 保留字节 */
}LMM_MM_RRM_RADIO_RESOURCE_CHECK_IND_STRU;
/*****************************************************************************
