...
/* Added by w00134354 for 美国限制驻留背景搜网项目, 2016-1-19, begin */
...
/* Added by w00134354 for 美国限制驻留背景搜网项目, 2016-1-19, end */
#define LRRC_GURRC_MAX_MCC_NUM                               (4)
#define LRRC_GURRC_MAX_BAND_NUM                              (20)
...
/* Added by s00184266 for 美国限制服务搜网项目, 2016-1-25, begin */
/*****************************************************************************
 结 构 名  : LRRC_GURRC_BG_PLMN_ID_LIST_STRU
 结构说明  : 背景搜PLMN 列表
 修改历史  :
  1.日  期   : 2016年1月25日
    作  者   : s00184266
...
/* Added by s00184266 for 美国限制服务搜网项目, 2016-1-25, end */

/*****************************************************************************
 结 构 名  : LRRC_GURRC_CSG_ID_INFO_STRU
 结构说明  : CSG ID类型
 修改历史  :
  1.日  期   : 2016年1月25日
    作  者   : s00184266
...
/*****************************************************************************
 结构名    :    LRRC_GURRC_MCC_INFO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :   WRRC指示LRRC网络国家码
*****************************************************************************/
typedef struct
{
    VOS_UINT8                                               ucMccNum;          /* W通知L当前网络国家码 */
    VOS_UINT8                                               aucReserved[3];
    LRRC_GURRC_MCC_STRU                                     astMcc[LRRC_GURRC_MAX_MCC_NUM];
}LRRC_GURRC_MCC_INFO_STRU;

/*****************************************************************************
 结构名    :    LRRC_GURRC_UE_SUPPORT_BAND_INFO_STRU
 协议表格  :
 ASN.1描述 :
 结构说明  :   LRRC指示UE支持频段
*****************************************************************************/
typedef struct
{
    VOS_UINT8                                               ucBandNum;          /* W通知L当前网络国家码 */
    VOS_UINT8                                               aucReserved[3];
    VOS_UINT16                                              ausBand[LRRC_GURRC_MAX_BAND_NUM];
}LRRC_GURRC_UE_SUPPORT_BAND_INFO_STRU;
