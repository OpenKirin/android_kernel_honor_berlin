...
//#endif
    ...
    TI_RRC_VOTLE_FAULT_TRIG_BYL2_AUTOAN_WAIT,    /* L2触发的Volte异常等待进入分析定时器 */
    TI_RRC_VOTLE_FAULT_TRIG_BYL2_AUTOAN_RPT,     /* L2触发的Volte异常分析完成等待上报定时器 */

    TI_RRC_INCREASE_CCPU_DDR_FREQ_TIMER,   /* 提频时启动，超时后降频 */
