...
enum LRRC_WRRC_MSG_TYPE_ENUM
{
   ...
   /* L -> W ANR STOP */
    ...
    /* Added by w00134354 for 美国限制驻留背景搜网项目, 2016-1-20, begin */
    ...
    /* Added by w00134354 for 美国限制驻留背景搜网项目, 2016-1-20, end */
...
typedef struct
{
    ...
    LRRC_GURRC_MCC_INFO_STRU                                stMccInfo;
...
typedef struct
{
    VOS_MSG_HEADER                                                              /*_H2ASN_Skip*/
    LRRC_WRRC_MSG_TYPE_ENUM_UINT32              enMsgId;                        /*_H2ASN_Skip*/
    /* Modified by s00184266 for 美国限制服务搜网项目, 2016-1-25, begin */
    LRRC_GURRC_BG_PLMN_ID_LIST_STRU             stBgPlmnIdList;                 /* plmn id列表 */
    /* Modified by s00184266 for 美国限制服务搜网项目, 2016-1-25, end */
...
/*****************************************************************************
 结构名    : WRRC_LRRC_SEARCHED_PLMN_INFO_IND_STRU
 结构说明  : W从模搜网过程中搜网到的pLMN上报给LRRC,Lrrc在上报给nas,该plmn必须满足驻留准则才能上报
...
/*****************************************************************************
 结构名    : LRRC_WRRC_SEARCHED_PLMN_INFO_IND_STRU
 结构说明  : L从模搜网过程中搜网到的pLMN上报给WAS,WAS在上报给nas,该plmn必须满足驻留准则才能上报
...
extern VOS_VOID  LRRC_GetLteBandSupported( const LRRC_GURRC_MCC_INFO_STRU   *pstMccInfo,LRRC_GURRC_UE_SUPPORT_BAND_INFO_STRU *pstSupportBand);
/*****************************************************************************
  9 OTHERS
*****************************************************************************/
