...
#define CSS_OM_200k_FREQ_MAX_NUM           (1000)          /* 200K频点最大个数 */

#define CSS_OM_G_SIGNAL_NUM                (50)            /* 支持GSM制式信号个数 */
#define CSS_OM_W_SIGNAL_NUM                (10)            /* 支持W制式信号个数 */
#define CSS_OM_L_SIGNAL_NUM                (20)            /* 支持L制式信号个数 */
#define CSS_OM_C_SIGNAL_NUM                (10)            /* 支持CDMA制式信号个数 */
#define CSS_OM_T_SIGNAL_NUM                (10)            /* 支持TD制式信号个数 */
#define CSS_OM_SIGNAL_TOLTAL_NUM           (CSS_OM_G_SIGNAL_NUM   \
                                           +CSS_OM_W_SIGNAL_NUM   \
                                           +CSS_OM_L_SIGNAL_NUM   \
                                           +CSS_OM_C_SIGNAL_NUM   \
                                           +CSS_OM_T_SIGNAL_NUM) /* 所有制式最大信号数 */
...
/*****************************************************************************
 结构名     : CSS_OM_RATRECOG_MATCH_STRU
 协议表格   :
 ASN.1描述  :
 结构说明   : 极值对数据结构
*****************************************************************************/
typedef struct
{
    VOS_UINT32                          ulLowIdx;      /* 能量区下边界PDP200K索引 */
    VOS_UINT32                          ulHighIdx;     /* 能量区上边界PDP200K索引 */

    VOS_UINT16                          enRat;          /* 判决的制式 */
    VOS_UINT16                          usRssi;         /* 信号的能量，单位-dBm */
}CSS_OM_RATRECOG_MATCH_STRU;

/*****************************************************************************
 结构名     : CSS_OM_RATRECOG_MATCH_RESULT_STRU
 协议表格   :
 ASN.1描述  :
 结构说明   : 信号极值对结果输出结构
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          usNumber;       /* astResutl中极值对个数 */
    VOS_UINT16                          usResv;                       /* 保留字段 */
    CSS_OM_RATRECOG_MATCH_STRU          astResult[CSS_OM_SIGNAL_TOLTAL_NUM];/* 信号数组 */
}CSS_OM_RATRECOG_MATCH_RESULT_STRU;

/*****************************************************************************
 结构名     : CSS_OM_PONIT_RSSI_STRU
 协议表格   :
 ASN.1描述  :
 结构说明   :
*****************************************************************************/
typedef struct
{
    VOS_UINT16                          usFreqCenter;  /* 信号中心频点，单位100kHz */
    VOS_UINT16                          enRat;         /* 信号制式 */
    VOS_INT16                           sRssi;         /* 信号能量，单位dBm */
    VOS_UINT16                          usBandWidth;   /* 信号带宽，单位100kHz */
    VOS_UINT32                          ulFreqCenterIdx; /* 信号中心频点，PDP200k索引 */
    VOS_UINT16                          enBand;         /* 频点所在的频段 */
    VOS_INT16                           sRssidBAve1;   /* 中心频点(或-600k)处1.2M带宽内dB域RSSI平均值，维测 */
    VOS_INT16                           sRssidBAve2;   /* 中心频点+600k处1.2M带宽内dB域RSSI平均值，维测 */
    VOS_UINT16                          usResv;        /* 保留字段 */
    VOS_UINT32                          ulVar3p8;      /* 3.8M方差，可维可测用 */
    VOS_UINT32                          ulVar4p8;      /* 4.4M方差，可维可测用 */
}CSS_OM_RATRECOG_SIGNAL_POINT_TMP_STRU;

/*****************************************************************************
 结构名     : CSS_OM_RATRECOG_RESULT_TMP_STRU
 协议表格   :
 ASN.1描述  :
 结构说明   : 中间判决结果
*****************************************************************************/
typedef struct
{
    VOS_UINT16                             usNumber;                       /* astResutl中有效信号个数 */
    VOS_UINT16                             usResv;                         /* 保留字段 */
    CSS_OM_RATRECOG_SIGNAL_POINT_TMP_STRU  astResult[CSS_OM_SIGNAL_TOLTAL_NUM];/* 中间判断信号数组 */
}CSS_OM_RATRECOG_RESULT_TMP_STRU;



/*****************************************************************************
 结构名     : CSS_OM_RATRECOG_SIGNAL_POINT_STRU
 协议表格   :
 ASN.1描述  :
 结构说明   : 输出信号的数据结构
*****************************************************************************/
...
/*****************************************************************************
 结构名     : CSS_OM_RECGONIZE_RESULT_STRU
 协议表格   :
 ASN.1描述  :
 结构说明   : 判决结果输出
*****************************************************************************/
typedef struct
{
    VOS_UINT8                               ucGNumber;        /* astResutl中有效信号个数 */
    VOS_UINT8                               ucWNumber;        /* astResutl中有效信号个数 */
    VOS_UINT8                               ucLNumber;        /* astResutl中有效信号个数 */
    VOS_UINT8                               ucCNumber;        /* astResutl中有效信号个数 */
    VOS_UINT8                               ucTNumber;        /* astResutl中有效信号个数 */
    VOS_UINT8                               ucResv0;          /* 保留字段 */
    VOS_UINT8                               ucResv1;          /* 保留字段 */
    VOS_UINT8                               ucResv2;          /* 保留字段 */
    CSS_OM_RATRECOG_SIGNAL_POINT_STRU       astGResult[CSS_OM_G_SIGNAL_NUM];/* 信号数组 */
    CSS_OM_RATRECOG_SIGNAL_POINT_STRU       astWResult[CSS_OM_W_SIGNAL_NUM];/* 信号数组 */
    CSS_OM_RATRECOG_SIGNAL_POINT_STRU       astLResult[CSS_OM_L_SIGNAL_NUM];/* 信号数组 */
    CSS_OM_RATRECOG_SIGNAL_POINT_STRU       astCResult[CSS_OM_C_SIGNAL_NUM];/* 信号数组 */
    CSS_OM_RATRECOG_SIGNAL_POINT_STRU       astTResult[CSS_OM_T_SIGNAL_NUM];/* 信号数组 */
}CSS_OM_RECGONIZE_RESULT_STRU;



/*****************************************************************************
 结构名     : CSS_OM_RAT_RECOGNIZE_RSLT_IND_STRU
 协议表格   :
 ASN.1描述  :
 结构说明   : ID_CSS_OM_RAT_RECOGNIZE_RSLT_IND对应的结构体，
*****************************************************************************/
typedef struct
{
    VOS_MSG_HEADER
    CSS_OM_MSG_ID_ENUM_UINT32               ulMsgId;                                     /*消息名称*/
    VOS_UINT16                              ausPoleMaxIdx[CSS_OM_200k_FREQ_MAX_NUM];     /* 极大值索引集合 */
    VOS_UINT16                              ausPoleMinIdx[CSS_OM_200k_FREQ_MAX_NUM];     /* 极小值索引集合 */
    CSS_OM_RATRECOG_MATCH_RESULT_STRU       stMatchRslt;         /* 极大极小值对集合 */
    CSS_OM_RATRECOG_RESULT_TMP_STRU         stSignalRsltTmp;     /* 信号识别临时结果 */
    CSS_OM_RECGONIZE_RESULT_STRU            stSignalRsltLast;    /* 信号识别最终结果 */
    VOS_UINT32                              ulRatRecognizeTime;   /* 算法耗时 */
}CSS_OM_RAT_RECOGNIZE_RSLT_IND_STRU;

/*****************************************************************************
 结构名     : CSS_OM_RAT_RECOGNIZE_NV_PARA_IND_STRU
 协议表格   :
 ASN.1描述  :
 结构说明   : ID_CSS_OM_RAT_RECOGNIZE_RSLT_IND对应的结构体，
*****************************************************************************/
typedef struct
{
    ...
    VOS_UINT16                                    usThresStep;      /* 计算能量差分值门限参数，默认值取10 */
