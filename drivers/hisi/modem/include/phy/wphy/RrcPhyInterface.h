...
/* V3 R7_7C1 End */
    ...
    PHYITF_PHY_E_RACH_UNRESET_MACE_OR_I = 519,             /* _H2ASN_MsgChoice PHYITF_E_RACH_REQ_STRU */
    PHYITF_PHY_BUTT
...
/*****************************************************************************
 枚举名    : PHYITF_SIB_TYPE_ENUM_UINT16
 协议表格  :
 ASN.1描述 :
 枚举说明  : SIB类型定义
*****************************************************************************/
enum PHYITF_SIB_TYPE_ENUM
{
/************************** Single 型sib定义 ********************************/
    PHYITF_SIB_TYPE_MIB                          = 0,
    PHYITF_SIB_TYPE_SB1                             ,
    PHYITF_SIB_TYPE_SB2                             ,
    PHYITF_SIB_TYPE_SIB1                            ,
    PHYITF_SIB_TYPE_SIB2                            ,
    PHYITF_SIB_TYPE_SIB3                            ,
    PHYITF_SIB_TYPE_SIB4                            ,
    PHYITF_SIB_TYPE_SIB5                            ,
    PHYITF_SIB_TYPE_SIB6                            ,
    PHYITF_SIB_TYPE_SIB7                            ,
    PHYITF_SIB_TYPE_SIB11                           ,
    PHYITF_SIB_TYPE_SIB12                           ,
    PHYITF_SIB_TYPE_SIB18                           ,
    PHYITF_SIB_TYPE_SIB11bis                        ,      /* 扩展SIB 1 */

    PHYITF_SIB_TYPE_SIB19                           ,      /* 扩展SIB 2 */

    /* 以上为目前支持的系统消息 */

    PHYITF_SIB_TYPE_SIB15                           ,
    PHYITF_SIB_TYPE_SIB151                          ,
    PHYITF_SIB_TYPE_SIB154                          ,
    PHYITF_SIB_TYPE_SIB155                          ,

    PHYITF_SIB_TYPE_SIB15bis                        ,      /* 扩展SIB 1 */
    PHYITF_SIB_TYPE_SIB151bis                       ,      /* 扩展SIB 1 */
    PHYITF_SIB_TYPE_SIB156                          ,      /* 扩展SIB 1 */
    PHYITF_SIB_TYPE_SIB157                          ,      /* 扩展SIB 1 */
    PHYITF_SIB_TYPE_SIB158                          ,      /* 扩展SIB 1 */

    PHYITF_SIB_TYPE_SIB20                           ,      /* 扩展SIB 1 */

    /* MULTI SIB */
    PHYITF_SIB_TYPE_SIB152                          ,
    PHYITF_SIB_TYPE_SIB153                          ,
    PHYITF_SIB_TYPE_SIB16                           ,
    PHYITF_SIB_TYPE_SIB152bis                       ,      /* 扩展SIB 1 */
    PHYITF_SIB_TYPE_SIB153bis                       ,      /* 扩展SIB 1 */
    PHYITF_SIB_TYPE_SIB152ter                       ,      /* 扩展SIB 2 */

    PHYITF_SIB_TYPE_EXT_BUTT                        ,
    PHYITF_SIB_TYPE_BUTT
};
typedef VOS_UINT16 PHYITF_SIB_TYPE_ENUM_UINT16;
...
/*****************************************************************************
 ...
 消息名称  :  PHYITF_BG_SEARCH_PRIORITY_ENUM
 功能描述  :  WPHY和WAS之间背景搜任务优先级枚举
 修改历史  :
  1.日    期    : 2016年04月06日
    作    者    : y00142674
    修改内容    : 新生成结构
*****************************************************************************/
enum PHYITF_BG_SEARCH_PRIORITY_ENUM
{
    PHYITF_BG_SEARCH_PRIORITY_LOW              = 0,        /* 背景搜任务低于数传任务 */
    PHYITF_BG_SEARCH_PRIORITY_MIDDLE           = 1,        /* 背景搜任务高于数传任务低于测量任务 */
    PHYITF_BG_SEARCH_PRIORITY_HIGH             = 2,        /* 背景搜任务高于测量任务 */

    PHYITF_BG_SEARCH_PRIORITY_BUTT
};
typedef VOS_UINT16 PHYITF_BG_SEARCH_PRIORITY_ENUM_UINT16;


/*****************************************************************************
 结 构 名  : RRC_PHY_BG_SEARCH_PRIORITY_IND_STRU
 结构说明  : ID_RRC_PHY_BG_SEARCH_PRIORITY_IND的消息结构
 修改历史  :
  1.日  期   : 2016年04月06日
    作  者   : y00142674
    修改内容 : 新生成结构
...
typedef struct
{
    VOS_MSG_HEADER                                                              /*_H2ASN_Skip */
    RRC_PHY_MSG_ID_ENUM_UINT16             enMsgID;                            /*_H2ASN_Skip */ /* 原语类型 */
    PHYITF_BG_SEARCH_PRIORITY_ENUM_UINT16  enPriority;                         /* 当前BG搜任务优先级 */
}RRC_PHY_BG_SEARCH_PRIORITY_IND_STRU;

/*****************************************************************************
 结构名    : RRC_PHY_MAX_SYSINFO_REPEAT_IND_STRU
 结构说明  : 系统消息全解模式下，指示物理层当前调度信息中具有最大调度周期的SIB类型，以及该SIB的调度周期
 修改历史  :
  1.日  期   : 2016年08月22日
    作  者   : z00184470
    修改内容 : 新生成结构
...
typedef struct
{
    VOS_MSG_HEADER                                                              /*_H2ASN_Skip*/
    RRC_PHY_MSG_ID_ENUM_UINT16                  enMsgID;                        /* 原语类型 */ /*_H2ASN_Skip*/
    PHYITF_SIB_TYPE_ENUM_UINT16                 enSibTypeWithMaxRepeat;         /* 具有最大调度周期的SIB类型 */
    VOS_UINT16                                  usMaxRepeat;                    /* 最大调度周期，单位为10ms */
    VOS_UINT16                                  usReserve1;
}RRC_PHY_MAX_SYSINFO_REPEAT_IND_STRU;
