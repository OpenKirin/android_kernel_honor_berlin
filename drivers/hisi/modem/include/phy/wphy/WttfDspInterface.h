...
/*  一般在判断是否到达激活时间等场景，都是判断一个范围，
    而不是一个点，以提高软件的健壮性 */
#define  WTTFPHY_CFG_ACT_CFN_PROTECT_RANGE          (8)
#define  WTTFPHY_CFG_ACT_CFN_PROTECT_RANGE_DSDS     (8)
...
enum WTTFPHY_MAC_STATUS_IND_ENUM
{
    ...
    WTTFPHY_MAC_STATUS_IND_NO_RF                      = 8,                 /* 无RF 资源*/
    WTTFPHY_MAC_STATUS_IND_OTHERS                     = 9,                 /* 其它类型 */
...
enum WTTFPHY_MSG_TYPE_ENUM
{
    ...
    ID_MAC_PHY_E_ACCESS_REQ             = 0x1110,           /* _H2ASN_MsgChoice WTTFPHY_EFACH_ACCESS_REQ_STRU */
    ID_PHY_MAC_E_ACCESS_CNF             = 0x3016,           /* _H2ASN_MsgChoice WTTFPHY_EFACH_ACCESS_CNF_STRU */
...
typedef struct
{
    ...
    */
    ...
    /*
       物理层读写
       仅在flexible size时使用:
       表示分段的PDU中已经发送了的Bit数, 单位:bit
    */
    VOS_UINT16                          usSegLeftBitLen;
