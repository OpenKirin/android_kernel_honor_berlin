...
#define RRC_PHY_MAX_PSCH_FREQ_NUM              (100)    /*下发给WDSP做PSCH的一组频点的最大个数*/

#define RRC_PHY_MAX_SAMPLE_FREQ_NUM_PER_BAND   (100)    /*一个band内采样的最大频点个数*/
...
enum    RRC_PHY_MSG_ID_ENUM
{
    ...
    ID_RRC_PHY_BG_SEARCH_PRIORITY_IND                       = 0x103B,   /* _H2ASN_MsgChoice RRC_PHY_BG_SEARCH_PRIORITY_IND_STRU */
    ID_RRC_PHY_MAX_SYSINFO_REPEAT_IND                       = 0x103C,   /* _H2ASN_MsgChoice RRC_PHY_MAX_SYSINFO_REPEAT_IND_STRU */
...
typedef struct
{
    ...
    RRC_PHY_MSG_ID_ENUM_UINT16          enMsgID;                /* 原语类型 */ /*_H2ASN_Skip*/
    VOS_UINT16                          usOPID;                 /* 操作标识 */
    VOS_INT16                           sBestCpichRscp;         /* 解广播期间当前小区的最强CPICH RSCP测量值 */
    VOS_INT16                           sBestCpichEcN0;         /* 解广播期间当前小区的最强CPICH EcN0测量值 */
...
typedef struct
{
    ...
    PHYITF_BOOL_ENUM_UINT16             enNeedRptBestMeasRslt;  /* 指示物理层是否需要将解广播期间监测到的当前小区的最强测量值信息上报给WAS */
