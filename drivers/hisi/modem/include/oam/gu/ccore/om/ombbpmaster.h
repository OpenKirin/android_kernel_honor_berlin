...
#define OM_BBPMASTER_KIRIN970_WR_CHAN_CNT               (26) /* 分配给KIRIN_970 GUX的写通道数目 */
#define OM_BBPMASTER_KIRIN970_RD_CHAN_CNT               (18) /* 分配给KIRIN_970 GUX的读通道数目 */

#define OM_BBPMASTER_MAX_WR_CHAN_CNT                    OM_BBPMASTER_KIRIN970_WR_CHAN_CNT /* 最大写通道数目 */
#define OM_BBPMASTER_MAX_RD_CHAN_CNT                    OM_BBPMASTER_KIRIN970_RD_CHAN_CNT /* 最大读通道数目 */
...
enum OM_BBPMASTER_IP_TYPE_ENUM
{
     ...
     OM_BBPMASTER_IP_Kirin970,                       /* Kirin970 BBP Master IP */
...
extern OM_BBPMASTER_CFG_DECFG_TYPE_ENUM_UINT32 OM_BbpMasterWrChannelDeConfig(OM_BBPMASTER_UINT32 ulPID,
                                                               OM_BBPMASTER_UINT32 ulChanId,
                                                               BBPMASTER_CHANNEL_DECONFIG_STRU *pstChanDeCfg);
extern OM_BBPMASTER_CHAN_STATE_ENUM_UINT32 OM_BbpMasterGetWrChanStatus(OM_BBPMASTER_UINT32 ulChanId);
extern OM_BBPMASTER_CHAN_STATE_ENUM_UINT32 OM_BbpMasterGetRdChanStatus(OM_BBPMASTER_UINT32 ulChanId);
