...
oal_uint8  dmac_sta_up_rx_ch_switch(mac_vap_stru *pst_mac_vap, oal_netbuf_stru *pst_netbuf)
{
    ...
    oal_uint8          *puc_csa_ie = OAL_PTR_NULL;
    ...
    puc_csa_ie = mac_find_ie(MAC_EID_CHANSWITCHANN, puc_data + us_index, us_framebody_len - us_index);
    if (OAL_PTR_NULL != puc_csa_ie)
    {
        uc_go_on = dmac_ie_proc_ch_switch_ie(pst_mac_vap, puc_csa_ie, MAC_EID_CHANSWITCHANN);
    }
