...
#define EDGE_ALGORITHM_CONFIG_BY_DTS "config_by_dts"
#define EDGE_ALGORITHM_EDGE_Y_MID   "edge_y_mid"
#define EDGE_ALGORITHM_EDGE_X_MAX   "edge_x_max"
#define EDGE_ALGORITHM_STOP_LIMITED "stop_limited"
#define EDGE_ALGORITHM_Y_MOVE_S     "y_move_s"
#define EDGE_ALGORITHM_Y_MOVE_M     "y_move_m"
#define EDGE_ALGORITHM_CENTER_X     "center_x"
#define EDGE_ALGORITHM_OFFSET_DIS   "offset_dis"
#define EDGE_ALGORITHM_EDGE_AX_LIMIT "edge_ax_limit"
#define EDGE_ALGORITHM_START_UPX_LIMIT "start_upx_limit"
#define EDGE_ALGORITHM_START_DNX_LIMIT "start_dnx_limit"
#define EDGE_ALGORITHM_EDGE_WIDETH     "edge_wideth"
#define ROI
#ifdef ROI
...
struct edge_performance_algorithm {
	int config_by_dts;
	int edge_y_mid;
	int edge_x_max;
	int stop_limited;
...
struct ts_device_data {
	...
	struct edge_performance_algorithm edge_performance_algorithm_data;
};
