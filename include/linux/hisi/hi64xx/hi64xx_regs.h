...
#define HI64xx_VAD_INT_SET         (HI64xx_DSP_SCTRL_BASE + 0x0)
#define HI64xx_CMD_STAT            (HI64xx_DSP_SCTRL_BASE + 0x08)
#define HI64xx_CMD_STAT_VLD        (HI64xx_DSP_SCTRL_BASE + 0x0c)
/* vir mm reg begin */
/* vir mm reg end */
